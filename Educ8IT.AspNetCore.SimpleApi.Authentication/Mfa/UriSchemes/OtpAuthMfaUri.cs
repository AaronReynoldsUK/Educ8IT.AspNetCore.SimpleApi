...
{
    /// <summary>
    /// Use this scheme to store MFA configuration in the DataStore
    /// </summary>
    public class OtpAuthMfaUri : CustomMfaUri
    {
        #region Constructors
        ...
        public OtpAuthMfaUri(string uriString) : base(uriString) { }
