...
namespace Educ8IT.AspNetCore.SimpleApi.Authentication.MfaScheme
{
    ...
    /// 
    /// </summary>
    public class MfaHandler : AuthenticationHandler<MfaOptions>, ICanAuthenticateRequest
    {
        #region Fields
        ...
        public MfaHandler(
            IOptionsMonitor<MfaOptions> options,
        ...
        public bool CanAuthenticateRequest(HttpContext context)
        {
            ...
            return context.CanAuthenticateRequest(
                MfaDefaults.AuthorisationHeaderName,
        ...
        public async Task UpdateClaimsAsync(ClaimsPrincipal claimsPrinciple, ApiUser apiUser, List<ApiUserToken> apiUserTokens)
        {
            ...
            var __accessToken = apiUserTokens.Where(t => t.TokenType == MfaDefaults.VerifyTokenName).FirstOrDefault();
